...
WEAK_ALIAS_FUNC(GPAB_IRQHandler, Default_Handler)          // External interrupt from PA[15:0]/PB[15:0]/PC[15:0]  
WEAK_ALIAS_FUNC(GPCDEF_IRQHandler, Default_Handler)          // External interrupt from PD[15:0]/PE[15:0]/PF[7:0] 
...
WEAK_ALIAS_FUNC(UART02_IRQHandler, Default_Handler)          // UART0 interrupt
...
WEAK_ALIAS_FUNC(UART3_IRQHandler, Default_Handler)          // UART3 interrupt
WEAK_ALIAS_FUNC(UART4_IRQHandler, Default_Handler)          // UART4 interrupt
WEAK_ALIAS_FUNC(UART5_IRQHandler, Default_Handler)          // UART5 interrupt
WEAK_ALIAS_FUNC(CAN0_IRQHandler, Default_Handler)			// CAN0 interrupt
WEAK_ALIAS_FUNC(CAN1_IRQHandler, Default_Handler)			// CAN1 interrupt
...
WEAK_ALIAS_FUNC(BPWM0_IRQHandler, Default_Handler)			// BPWM0 interrupt
WEAK_ALIAS_FUNC(BPWM1_IRQHandler, Default_Handler)			// BPWM1 interrupt
WEAK_ALIAS_FUNC(BRAKE0_IRQHandler, Default_Handler)			// BRAKE0 interrupt
WEAK_ALIAS_FUNC(BRAKE1_IRQHandler, Default_Handler) 		// BRAKE1 interrupt
...
WEAK_ALIAS_FUNC(PWRWU_IRQHandler, Default_Handler)           // Power Down Wake up interrupt
WEAK_ALIAS_FUNC(ADC_IRQHandler, Default_Handler)            // ADC interrupt
WEAK_ALIAS_FUNC(CKD_IRQHandler, Default_Handler)            // Real time clock interrupt
...
const uint32_t __vector_handlers[] = {
    ...
    (uint32_t) GPAB_IRQHandler,        // External interrupt from PA[15:0]/PB[15:0]/PC[15:0]  
    (uint32_t) GPCDEF_IRQHandler,        // External interrupt from PD[15:0]/PE[15:0]/PF[7:0]
	0,									// Reserved
	0,									// Reserved
    ...
    (uint32_t) UART02_IRQHandler,        // UART0 interrupt
    (uint32_t) UART1_IRQHandler,        // UART1 interrupt
    (uint32_t) SPI0_IRQHandler,         // SPI0 interrupt 
    (uint32_t) UART3_IRQHandler,		// UART3 interrupt
	(uint32_t) UART4_IRQHandler,		// UART4 interrupt
	(uint32_t) UART5_IRQHandler,		// UART5 interrupt
    (uint32_t) I2C0_IRQHandler,         // I2C0 interrupt 
    (uint32_t) I2C1_IRQHandler,         // I2C1 interrupt
	(uint32_t) CAN0_IRQHandler,			// CAN0 interrupt
    (uint32_t) CAN1_IRQHandler,			// CAN1 interrupt
    (uint32_t) PWM0_IRQHandler,			// PWM0 interrupt
  	(uint32_t) PWM1_IRQHandler,			// PWM1 interrupt
  	(uint32_t) BPWM0_IRQHandler,		// BPWM0 interrupt	
  	(uint32_t) BPWM1_IRQHandler,		// BPWM1 interrupt
  	(uint32_t) BRAKE0_IRQHandler,		// BRAKE0 interrupt
  	(uint32_t) BRAKE1_IRQHandler,  		// BRAKE1 interrupt
    (uint32_t) PWRWU_IRQHandler,        // Power Down Wake up interrupt
    (uint32_t) ADC_IRQHandler,          // ADC interrupt
    (uint32_t) CKD_IRQHandler,          // Clock detection interrupt
};
