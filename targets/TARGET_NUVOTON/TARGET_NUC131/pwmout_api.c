...
static const struct nu_modinit_s pwm_modinit_tab[] = {
    {PWM_0_0, PWM0_MODULE, CLK_CLKSEL3_PWM0_S_PLL, 0, PWM0_RST, PWM0_IRQn, &pwm0_01_var},
    {PWM_0_1, PWM0_MODULE, CLK_CLKSEL3_PWM0_S_PLL, 0, PWM0_RST, PWM0_IRQn, &pwm0_01_var},
    {PWM_0_2, PWM0_MODULE, CLK_CLKSEL3_PWM0_S_PLL, 0, PWM0_RST, PWM0_IRQn, &pwm0_23_var},
    {PWM_0_3, PWM0_MODULE, CLK_CLKSEL3_PWM0_S_PLL, 0, PWM0_RST, PWM0_IRQn, &pwm0_23_var},
    
    {PWM_1_0, PWM1_MODULE, CLK_CLKSEL3_PWM1_S_PLL, 0, PWM1_RST, PWM1_IRQn, &pwm1_01_var},
    {PWM_1_1, PWM1_MODULE, CLK_CLKSEL3_PWM1_S_PLL, 0, PWM1_RST, PWM1_IRQn, &pwm1_01_var},
    {PWM_1_2, PWM1_MODULE, CLK_CLKSEL3_PWM1_S_PLL, 0, PWM1_RST, PWM1_IRQn, &pwm1_23_var},
    {PWM_1_3, PWM1_MODULE, CLK_CLKSEL3_PWM1_S_PLL, 0, PWM1_RST, PWM1_IRQn, &pwm1_23_var},
...
static void pwmout_config(pwmout_t* obj)
{
    ...
    PWM_ConfigOutputChannel(pwm_base, chn, 1000000/obj->period_us, 100-(obj->pulsewidth_us * 100 / obj->period_us));
}
