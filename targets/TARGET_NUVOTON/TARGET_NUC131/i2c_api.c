...
void i2c_init(i2c_t *obj, PinName sda, PinName scl)
{
    ...
    const struct nu_modinit_s *modinit = get_modinit(obj->i2c, i2c_modinit_tab);
    MBED_ASSERT(modinit != NULL);
    MBED_ASSERT((I2CName) modinit->modname == obj->i2c);
    ...
    I2C_Open((I2C_T *) NU_MODBASE(obj->i2c), 100000);
    ...
    //i2c_base->I2CON |= (I2C_I2CON_EI_Msk | I2C_I2CON_ENS1_Msk);
...
{
    return i2c_do_trsn(obj, I2C_I2CON_STA_Msk | I2C_I2CON_SI_Msk, 1);
}

int i2c_stop(i2c_t *obj)
{
    return i2c_do_trsn(obj, I2C_I2CON_STO_Msk | I2C_I2CON_SI_Msk, 1);
}

void i2c_frequency(i2c_t *obj, int hz)
{
    I2C_SetBusClockFreq((I2C_T *) NU_MODBASE(obj->i2c), hz);
}
...
void i2c_slave_mode(i2c_t *obj, int enable_slave)
{
    ...
    i2c_set_control_reg(i2c_base, I2C_I2CON_SI_AA);
...
static int i2c_do_trsn(i2c_t *obj, uint32_t i2c_ctl, int sync)
{
    ...
    if (i2c_poll_status_timeout(obj, i2c_is_trsn_done, NU_I2C_TIMEOUT_STAT_INT)) {
        ...
        case 0xF8:  // Bus Released
            if ((i2c_ctl & (I2C_I2CON_STA_Msk | I2C_I2CON_STO_Msk)) == I2C_I2CON_STO_Msk) {
                return 0;
            }
            else {
                break;
...
static int i2c_is_trsn_done(i2c_t *obj)
{
    ...
    i2c_int = !! (i2c_base->I2CON & I2C_I2CON_EI_Msk);
...
{
    /*if (obj->hdlr_async) {
        void (*hdlr_async)(void) = (void(*)(void))(obj->hdlr_async);
        hdlr_async();
        return;
    }*/
    ...
    switch (status) {
        ...
        case 0x10:  // Master Repeat Start
            if ((obj->tran_ctrl & TRANCTRL_STARTED) && obj->tran_pos) {
                if (obj->tran_pos < obj->tran_end) {
                    ...
                    i2c_set_control_reg(i2c_base, I2C_I2CON_SI_Msk | I2C_I2CON_AA_Msk);
                }
                else {
        ...
        case 0x38:  // Master Arbitration Lost
            i2c_fsm_reset(obj, I2C_I2CON_SI_Msk | I2C_I2CON_AA_Msk);
            break;
            ...
            if ((obj->tran_ctrl & TRANCTRL_STARTED) && obj->tran_pos) {
                if (obj->tran_pos < obj->tran_end) {
                    ...
                    if (status == 0x58) {
                        ...
                        uint32_t i2c_ctl = I2C_I2CON_SI_Msk | I2C_I2CON_AA_Msk;
                        if ((obj->tran_end - obj->tran_pos) == 1 &&
                            obj->tran_ctrl & TRANCTRL_NAKLASTDATA) {
                            // Last data
                            i2c_ctl &= ~I2C_I2CON_AA_Msk;
                        }
                        i2c_set_control_reg(i2c_base, i2c_ctl);
                    }
                }
